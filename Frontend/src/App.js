...
// Route Guards
import { ProtectedRoute, AdminRoute, UserOrAdminRoute } from './service/guard';

// Booking Calendar Component
import BookingCalendar from './component/common/BookingCalendar';
        ...
        <div className="content">
          <Routes>
           ...
           <Route path="/BookingCalendar" element={<BookingCalendar />} />
            ...
            {/* 👇 UPDATED: Allow both USER and ADMIN */}
            <Route
              path="/admin/edit-booking/:bookingCode"
              element={<UserOrAdminRoute element={<EditBookingPage />} />}
            />
