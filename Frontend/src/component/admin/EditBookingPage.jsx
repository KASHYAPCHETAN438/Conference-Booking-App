...
const EditBookingPage = () => {
  ...
  const deleteBooking = async () => {
    ...
    try {
      const response = await ApiService.cancelBooking(bookingDetails.id, cancelReason);
    ...
    <div className="edit-booking-container">
      ...
      {bookingDetails && (
        <div className="booking-card">
          ...
          <p><strong>Date:</strong> {bookingDetails.checkInDate}</p>
          ...
          <div className="button-group">
            <button className="delete-btn" onClick={deleteBooking}>Cancel Booking</button>
