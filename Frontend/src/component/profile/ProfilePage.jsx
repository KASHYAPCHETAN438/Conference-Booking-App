...
const handleConfirmUpdate = async () => {
  ...
  if (selectedSlots.some(slot => bookedSlotLabels.includes(slot.label))) {
    setError("Selected slots are already booked.");
    return;
  }
  ...
  try {
    ...
    setUser(prev => ({
      ...
      bookings: prev.bookings.map(b =>
        b.id === updatingBooking.id ? { ...b, checkInDate: newCheckInDate, timeSlots: selectedSlots } : b
      )
    }));
    ...
    <div className="profile-page container">
      ...
      <div className="bookings-section">
        ...
        <div className="booking-list">
          ...
          {(success || error) && (
          <div className={`toast-message ${error ? 'error' : ''}`}>
        {success || error}
         </div>
        )}
