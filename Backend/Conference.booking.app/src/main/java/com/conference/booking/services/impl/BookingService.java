...
public class BookingService implements IBookingService {
    ...
    // cancel Booking Send logic added

//    @Override
//    public Response cancelBooking(Long bookingId, String cancelledByRole) {
//        Response response = new Response();
//        try {
...
//            String subject = "Booking Cancellation-Conference Room";
//
//            DateTimeFormatter timeFormatter = DateTimeFormatter.ofPattern("hh:mm a");
//            StringBuilder slotDetails = new StringBuilder();
//            for (TimeSlot slot : booking.getTimeSlots()) {
//                slotDetails.append(" - ")
//                        .append(slot.getStartTime().format(timeFormatter))
//                        .append(" to ")
//                        .append(slot.getEndTime().format(timeFormatter))
//                        .append("\n");
//            }
//
//
...
//                message = "Dear " + booking.getUser().getName() + ",\n\n" +
//                        "\u26A0 Your booking has been cancelled due to unavailability:\n\n" +
...
//
//            response.setStatusCode(200);
//            response.setMessage("Booking cancelled and email sent successfully");
//
//        } catch (OurException e) {
//            response.setStatusCode(404);
//            response.setMessage(e.getMessage());
...
//    }
    ...
    @Override
    public Response cancelBooking(Long bookingId, String cancelledByRole, String reason) {
        Response response = new Response();
        try {
            Booking booking = bookingRepository.findById(bookingId)
                    .orElseThrow(() -> new OurException("Booking not found"));
            ...
            if ("ADMIN".equalsIgnoreCase(cancelledByRole)) {
                message = "Dear " + booking.getUser().getName() + ",\n\n" +
                        "\u26A0 Your booking has been cancelled by the administrator for the following reason:\n\n" +
                        "\"" + reason + "\"\n\n" +
                        "\uD83D\uDCCD Room: " + booking.getRoom().getRoomType() + "\n" +
                        "\uD83D\uDCC5 Date: " + booking.getCheckInDate() + "\n" +
                        "\u23F1 Time Slots:\n" + slotDetails +
